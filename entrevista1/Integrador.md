...
Que, que es cuando los estudiantes vienen y también se van. Nosotros también tenemos procedimientos para docentes, para funcionarios y para la comunidad en general. Y ¿cómo promovemos esa experiencia para la comunidad? Mediante los idiomas, que es el área que yo lidero. Y esa área es la que nosotros necesitamos apoyo en este momento, porque la parte de movilidad estudiantil ya está bien afianzada en el campus.


Todos conocen lo que es para irse de intercambio o más o menos, pero sí conocen relaciones internacionales inmediatamente con eso. Y nosotros nos gustaría que también se relaciona con las otras actividades que hacemos y con los idiomas sobre todo, porque, eh, es un área que no está afianzada como la movilidad y, y tiene la misma tiempo de antigüedad.
...
Está una persona que revisa los convenios internacionales y, eh, apoya las relaciones internacionales. Está una ingeniera de estudios que ve datos y información relevante de, del área, del área internacional. Eh, después, en Coquimbo hay una persona a cargo de movilidad estudiantil para Antofagasta y Coquimbo y, eh, también refuerza otras áreas de internacional allá en Coquimbo.


Y en Antofagasta estoy yo, que veo idiomas, internacionalización, que tiene que ver con metodología y, y prof-- y trabajo con profesores y con la comunidad que vendrían siendo los idiomas. Eh, está la American Corner, que es un espacio de diplomacia de la Embajada de Estados Unidos, que también es de nuestra dirección y ahí también se ve movilidad estudiantil.
...
Ese era como el objetivo cuando empezamos a trabajar con las, con las profes. Y las mayores solicitudes que presentan es-- nosotros tenemos una plataforma de aprendizaje que es pagada, pero la solicitud que presentan es que haya un flujo de información más, eh, expedito y ojalá que haya un portal donde se puedan subir las notas, porque nosotros tenemos un, como te decía, una plataforma que pagamos, pero esa plataforma no permite alojar evaluaciones, ponte tú.


Ya. Y, y en el caso que de mí como-- ah, no, me quedé, todavía. Eh, y en el caso de mí como coordinadora, me gustaría también tener esa, esa plataforma de, de notas y ahí mismo llevar también los pagos para que así más fácil de, de tener la base de datos actualizada cuando pidan los certificados y todo lo demás.
...
Ah. Y también otra de las dificultades de los estudiantes de intercambio es que a la vuelta-- tú dices los UCN que se van, ¿cierto? Mhm. Ya. Los UCN que se van después cuando vuelven también es muy lento el proceso de, de convalidación


Sí, eso lo había escuchado, pero eso es porque generalmente las mallas que tienen entre un país y otro no son, eh, idénticas, ¿cierto? Efectivamente, y también porque a veces depende mucho del criterio del jefe de carrera. Entonces, estamos trabajando en, mmm, en mejorar ese proceso. Pero ahí es como más-- es como un tema un poco más amplio, como que con un maestro no creo que-- porque tenemos ya el procedimiento, pero como que igual sigue siendo lento.
...
En la misma plantilla está el horario. Eh, pero aún así es lento el proceso porque, eh, los cursos son por convocatoria. Entonces, nosotros abrimos una convocatoria en marzo y otra en agosto. Entonces, dependiendo de la cantidad de personas que se inscriben, nosotros podemos abrir el curso o no, por temas de recursos, porque tenemos que pagarle a un docente que dicte la asignatura.
...
Mmm. Y la persona tiene que esperar todo ese mes a ver si se abre el curso o no. Claro. Entonces, en ese mes yo debo de ser bien honesta y la verdad es que no hay seguimiento tampoco de nuestra parte, porque no sabemos si vamos a abrir o no el curso. Claro. Y claro, entonces entre esa incertidumbre, eh, eh, ahí también se genera como una dificultad.
...
Eh, y esto que les mencionaba anteriormente, que hay dos formaciones generales electivas en el año que los estudiantes tampoco conocen. Y en esas formaciones generales electivas no tienen que pagar. Y también están los grupos de conversación del American Corner, que son gratuitos también y no, no sabe la gente que eso está.


Claro. Y esa es nuestro-- nuestra mayor como, eh, debilidad o que no-- efectivamente, la-- ocupamos canales de comunicación, pero no sé si están siendo eficientes porque no conoce la gente de los idiomas, po. Y los alumnos sobre todo, que es nuestro principal grupo objetivo. Mmm. Para eso hacemos los cursos, porque los cursos son para que los estudiantes puedan-- nosotros cobramos un dinero, que es el más bajo del mercado, debo decir, pero cobramos ese dinero para que los estudiantes se puedan ir de movilidad, porque con los recursos que nosotros generamos de estos cursos, eh, se hacen becas para movilidad estudiantil.
...
Claro, ahí está todo disperso, hay que tener mucho cuidado. Sí, y esa es una dificultad que tenemos de las bases de datos, sí. Bueno saberlo entonces, porque eso nos va a servir harto para tener en cuenta para el proyecto. 
...
Ahí mismo también podemos ver los pagos. Entonces, así podemos gestionar los certificados y que todo eso esté en un solo lugar, porque ahora está un Excel para los pagos, un Excel para el, para las notas, un Excel para la asistencia. Entonces, o sea, la asistencia está en la misma, el mismo Excel, pero no es un sistema, po.
Y como te decía, se pierde un Excel y se pierde todo, po.
